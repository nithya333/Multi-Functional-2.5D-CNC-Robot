...
class AudioThread(QThread):
    ...
    def __init__(self, input_device_index=None):
        ...
        # self.model = Model(r'D:\\Engg RV\\EL\\Sem II\\CNC Plotter EL\\GCodes\\0_FinalSoftware_Version2.0\\Shared_CNC_code\\CNC\\vosk-model-small-en-us-0.15')
        self.model = Model(os.path.join(os.getcwd(),"vosk-model-small-en-us-0.15"))
        print(self.model)
